    ...
    <PhoneShell>
      <div className="px-6 pt-4 pb-24 overflow-y-auto flex-1">
        ...
        <div className="flex items-start gap-5 mt-2">
          <div className="h-24 w-24 rounded-full overflow-hidden border border-border/70 shrink-0 shadow-md flex items-center justify-center bg-slate-900 text-white">
            {profileImgSrc === "APPLE_AVATAR" ? (
              <svg viewBox="0 0 24 24" className="h-10 w-10 fill-current text-slate-300">
